...
CCNumValidationResults validateCardNumber(String ccNumStr,
  ...
  int maxCardLength = _ccNumLengths.containsKey(type)
      ? _ccNumLengths[type]!.reduce(max)
      : _DEFAULT_MAX_CARD_NUM_LENGTH;
  ...
  if (potentialForMoreDigits) {
    failedMessage =
        ''; // Not an failed validation since there could be more digits being typed in
  }
