...
Widget getCardTypeIcon({CardType? cardType, String? cardNumber}) {
  switch (cardType ?? getCardType(cardNumber!)) {
    case CardType.americanExpress:
      return Image.asset(
        'assets/images/card_provider/american_express.png',
        width: 55,
        height: 40,
      );
    case CardType.dinersClub:
      return Image.asset(
        'assets/images/card_provider/diners_club.png',
        width: 40,
        height: 40,
      );
    case CardType.discover:
      return Image.asset(
        'assets/images/card_provider/discover.png',
        width: 70,
        height: 50,
      );
    case CardType.jcb:
      return Image.asset(
        'assets/images/card_provider/jcb.png',
        width: 40,
        height: 40,
      );
    case CardType.masterCard:
      return Image.asset(
        'assets/images/card_provider/master_card.png',
        width: 55,
        height: 40,
      );
    case CardType.maestro:
      return Image.asset(
        'assets/images/card_provider/maestro.png',
        width: 55,
        height: 40,
      );
    case CardType.rupay:
      return Image.asset(
        'assets/images/card_provider/rupay.png',
        width: 80,
        height: 50,
      );
    case CardType.visa:
      return Image.asset(
        'assets/images/card_provider/visa.png',
        width: 55,
        height: 40,
      );
    case CardType.elo:
      return Image.asset(
        'assets/images/card_provider/elo.png',
        width: 50,
        height: 50,
      );
    default:
