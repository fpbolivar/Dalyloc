...
class LikesFoodListView extends StatefulWidget {
  String? red;
  LikesFoodListView({Key? key, this.red, this.gotoNext = false})
      : super(key: key);
  bool? gotoNext = false;
  @override
  State<LikesFoodListView> createState() => _LikesFoodListViewState();
}

class _LikesFoodListViewState extends State<LikesFoodListView> {
  ...
  getTag() async {
    List<FoodTagsModel>? tempResponse = await manager.getDislikesFood();
                            ...
                            if (result != null && goToNext) {
                              ...
                              if (result == true) {
                                ToastMessage.showSuccessMessage(
                                    msg: "Your Likes items has been updated.",
