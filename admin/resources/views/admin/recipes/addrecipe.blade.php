                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter recipe name" name="meal_name">
                                    @error("meal_name")
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter cooking time" name="cooking_time">
                                    @error("cooking_time")
                                    <span class="help-block text text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" placeholder="Enter calorie count" name="calorie_count">
                                    @error("calorie_count")
                                    <span class="help-block text text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <table id="ingredientsTable" style="width:100%;">
                                ...
                                <tr> @php $i=1;
                                    ...
                                    <td>
                                        <input type="text" class="form-control" placeholder="Enter Quantity" name="quantity[]" id="quantity_1" required>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <table id="instructionsTable" style="width:100%;">
                                ...
                                <tr> @php $i=1;
                                    ...
                                    <td><label class="labeld"></label></td>
                                    <td style="width: 20%">
                                        <input type="number" class="form-control" placeholder="Step No." name="step[]" id="step_1" required>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" placeholder="Instruction" name="instruction[]" id="instruction_1" required>
                                    </td>
                                </tr>
                            </table>
                        </div>
