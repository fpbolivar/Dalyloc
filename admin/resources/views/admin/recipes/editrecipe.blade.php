                ...
                <form class="card" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter recipe name" name="meal_name" value="{{$editRecipe->meal_name}}">
                                    @error("meal_name")
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select data-placeholder="Choose Meal Category" class="form-control chosen-select" multiple tabindex="4" id="meal_category">
                                        <option value=""></option>
                                        @foreach($meal_categories as $meal_category)
                                            @if(in_array($meal_category['id'], explode(',', $editRecipe->meal_category_id)))
                                            <option value="{{$meal_category['id']}}" selected>{{$meal_category['name']}}</option>
                                            @else
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select data-placeholder="Choose Menu Type" class="form-control chosen-select" multiple tabindex="4" id="menu_type">
                                        <option value=""></option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select data-placeholder="Choose Meal Cookware" class="form-control chosen-select" multiple tabindex="4" id="meal_cookware">
                                        <option value=""></option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter cooking time" name="cooking_time" value="{{$editRecipe->meal_cooking_timing}}">
                                    @error("cooking_time")
                                    <span class="help-block text text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" placeholder="Enter calorie count" name="calorie_count" value="{{$editRecipe->meal_calories}}">
                                    @error("calorie_count")
                                    <span class="help-block text text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="body">
                                        ...
                                        <input name="meal_image" type="file" class="dropify-event" data-default-file="{{asset($editRecipe->meal_image)}}"
                        ...
                        <div class="card-body">
                            @include('admin.layouts.message')
                            <div>
                                <a onclick="addField('ingredients');"><i class="zmdi zmdi-plus-circle-o zmdi-hc-fw"></i></a>
                            ...
                            <table id="ingredientsTable" style="width:100%;">
                                ...
                                <tr>
                                    ...
                                    <input type="hidden" value="{{$editMealIngredient->id}}" name="mealingredientsids[]">
                                    <td>
                                        <select name="ingredients[]" id="ingredient_{{$i}}" class="form-control" required>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" placeholder="Enter Quantity" name="quantity[]" id="quantity_{{$i}}" value="{{$editMealIngredient->quantity}}" required>
                                    </td>
                                </tr>
                                @php $i++; @endphp
                                @endforeach
                        ...
                        <div class="card-body">
                            @include('admin.layouts.message')
                            <div>
                                <a onclick="addField('instructions');"><i class="zmdi zmdi-plus-circle-o zmdi-hc-fw"></i></a>
                            ...
                            <table id="instructionsTable" style="width:100%;">
                                ...
                                <tr> 
                                    <td><label class="labeld"></label></td>
                                    <input type="hidden" value="{{$editMealInstruction->id}}" name="mealinstructionsids[]">
                                    <td style="width: 20%">
                                        <input type="number" class="form-control" placeholder="Step No." name="step[]" id="step_1" value="{{$editMealInstruction->step_no}}" required>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" placeholder="Instruction" name="instruction[]" id="instruction_1" value="{{$editMealInstruction->description}}" required>
                                    </td>
                                </tr>
                                @php $i++; @endphp
                                @endforeach
