...
@section('contents')
@section('title') {{'View Workout Levels' }} @endsection

<div class="app-content  my-3 my-md-5">
    <div class="side-app">
        <div class="page-header">
            <h6 class="page-title">View Workout Levels </h6>
        </div>
            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">View Workout Levels </div>
                        <div class="ml-auto"><a href="{{ url('/admin/add-workout-level') }}" title="Add Workout Levels"
                            ...
                            <table id="usersTable" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="wd-15p">Workout Description</th>
