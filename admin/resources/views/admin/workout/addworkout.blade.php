                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select  class="form-control select2" name="level_id" data-placeholder="Choose Workout Level">
                                            <option selected>Choose Workout Level</option>
                                            <?php  foreach($names as $name) { ?>
                                                        <option value="<?= $name['id'] ?>"><?= $name['workout_name'] ?></option>
                                            <?php   } ?>
                                        </select> 
                                        @error("workout_name")
                                        <span class="help-block  text text-danger">{{$message}}</span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="body">
                                        ...
                                        <input type="type" class="form-control"  name="workout_time" placeholder="Enter Workout Time"> 
                                        @error("workout_time")
                                        <span class="help-block  text text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
