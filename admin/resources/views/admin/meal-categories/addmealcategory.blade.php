...
<div class="app-content  my-3 my-md-5">
    <div class="side-app">
        <div class="page-header">
            <h6 class="page-title">Add Meal Category</h6>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
					<a href="{{env('BACK_URL').'meal-categories'}}"> 
            ...
            <div class="col-lg-12">
                <form class="card" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Add Meal Category</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Meal Category Name</label>
                                    <input type="text" class="form-control" placeholder="Enter meal category name" name="name">
                                    @error("name")
