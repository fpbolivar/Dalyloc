...
@section('contents')
@section('title') {{'Edit Meal Category'}} @endsection
            ...
            <div class="col-lg-12">
                <form class="card" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Edit Meal Category</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="body">
                                    ...
                                    <input name="image" type="file" class="dropify-event"
                                        data-default-file="{{ $editMealCategory->image ? asset($editMealCategory->image) : '' }}"
