...
@section('contents')
@section('title') {{'Edit Meal Size'}} @endsection

<div class="app-content  my-3 my-md-5">
    <div class="side-app">
        <div class="page-header">
            <h6 class="page-title">Edit Meal Size</h6>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <form class="card" method="post" action="">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Edit Meal Size</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter meal name"
                                        name="meal_name" value="{{$getMealSize->name}}" maxlength="50">
                                    @error("meal_name")
                            ...
                            <div class="col-md-6">
                                <div class="body">
                                    ...
                                    <textarea rows="5" cols="5" class="form-control" name="meal_description"
                                        maxlength="50">{{$getMealSize->description}}</textarea>
