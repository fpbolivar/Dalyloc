...
<div class="app-content  my-3 my-md-5">
    <div class="side-app">
        <div class="page-header">
            <h6 class="page-title">Add Meal Cookware</h6>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <form class="card" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Add Meal Cookware</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label">Meal Cookware Name</label>
                                    <input type="text" class="form-control" placeholder="Enter meal cookware name" name="name">
                                    @error("name")
